...
/**
 * Brand mark — horn-rim / browline silhouette.
 * Thick brow bar across both lenses + bridge; thin U-shape under each
 * lens. 1950s Wayfarer-adjacent. Stroke uses currentColor so it
