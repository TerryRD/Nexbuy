...
// TODO: replace with the real LINE official-account URL (or move to env var).
// "@your-line-id" works as a placeholder; real format is https://lin.ee/XXXX.
const LINE_URL = "https://line.me/R/ti/p/@example";

/**
 * Floating action button anchored to the bottom-right of the viewport.
 * Site-wide quick channel to contact the shop via LINE. Brand colour
 * #06C755 (LINE green) so it's instantly recognisable.
 */
  ...
  return (
    ...
    >
      {/* Simple LINE-style speech bubble icon. lucide-react doesn't ship a
          ...
          brand recognition without adding a new dep. */}
      <svg
        viewBox="0 0 24 24"
        className="size-7"
        fill="currentColor"
