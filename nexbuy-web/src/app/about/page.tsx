...
export const metadata: Metadata = {
  title: "品牌故事 — 精鋐眼鏡行",
  description:
    "精鋐眼鏡行：在地服務、專業驗光、精選鏡框，讓挑眼鏡變成一件愉快的事。",
};
  ...
  return (
    <div className="relative">
      ...
      <section className="relative isolate overflow-hidden">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-b from-secondary/50 via-background to-background"
        />
        <div
          aria-hidden
          className="animate-aurora pointer-events-none absolute -top-40 left-1/2 -z-10 size-[40rem] -translate-x-1/2 rounded-full bg-gradient-to-br from-primary/35 via-chart-1/30 to-accent/40 blur-3xl"
        />
        <div
          aria-hidden
          className="animate-aurora-slow pointer-events-none absolute -bottom-40 -right-32 -z-10 size-[36rem] rounded-full bg-gradient-to-br from-accent/40 via-chart-2/25 to-primary/20 blur-3xl"
        />
        <div
          aria-hidden
          className="animate-aurora pointer-events-none absolute -bottom-32 -left-32 -z-10 size-[28rem] rounded-full bg-chart-1/25 blur-3xl"
        />

        <div className="mx-auto flex min-h-[78svh] max-w-5xl flex-col items-center justify-center px-4 py-24 text-center">
          <span className="inline-flex animate-in fade-in slide-in-from-bottom-2 items-center gap-2 rounded-full border border-border/60 bg-card/60 px-3 py-1 text-xs font-medium text-muted-foreground backdrop-blur duration-700">
            <Sparkles className="size-3.5 text-chart-1" />
            JING HONG OPTICAL · 在地眼鏡行
          </span>
          <h1 className="mt-6 animate-in fade-in slide-in-from-bottom-4 font-heading text-5xl font-semibold leading-[1.05] tracking-tight duration-1000 md:text-7xl lg:text-8xl">
            <span className="text-sheen">精鋐眼鏡行</span>
          </h1>
          <p className="mt-6 max-w-2xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-muted-foreground duration-1000 md:text-xl">
            把鏡框與鏡片，
            <span className="text-foreground">配得剛剛好</span>。
            <br className="hidden sm:block" />
            一副好戴的眼鏡，是一段為自己挑選日常夥伴的儀式。
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <Link
          ...
          <div
            aria-hidden
            className="animate-float-soft pointer-events-none mt-16 flex items-center gap-3 text-xs uppercase tracking-[0.2em] text-muted-foreground/70"
          >
